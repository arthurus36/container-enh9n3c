...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-enh9n3c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-enh9n3c.containers.anotherwebservice.com/
...
```
git clone git@github.com:arthurus36/container-enh9n3c.git
cd container-enh9n3c
```
...
```
docker attach container-enh9n3c
```
